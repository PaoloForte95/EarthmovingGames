(define (problem s1)
    ...
    (= (distance wp3 wp8) 10)
    (= (distance wp8 wp3) 10)
    (= (distance wp8 wp11) 10)
    (= (distance wp11 wp8) 10)
    (= (distance wp11 wp10) 10)
    (= (distance wp10 wp11) 10)
    (= (distance wp10 wp9) 10)
    (= (distance wp9 wp10) 10)
    (= (distance wp9 wp4) 10)
    (= (distance wp4 wp9) 10)
    (= (distance wp4 wp1) 10)
    (= (distance wp1 wp4) 10)
    ...
    (= (distance wp6 wp7) 10)
    (= (distance wp7 wp6) 10)
    (= (distance wp7 wp11) 10)
    (= (distance wp11 wp7) 10)
    (= (distance wp2 wp6) 10)
    (= (distance wp6 wp2) 10)
    (= (distance wp6 wp10) 10)
    (= (distance wp10 wp6) 10)
